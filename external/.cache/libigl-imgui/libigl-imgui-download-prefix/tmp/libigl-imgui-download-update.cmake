...
if(fetch_required)
  _ep_message_quiet_capture(VERBOSE "Fetching latest from the remote origin")
  execute_process(
  ...
  _ep_command_check_result(
    error_code "Failed to fetch from the remote origin'"
  )
endif()
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/cmd/git.exe" for-each-ref
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      _ep_message_quiet_capture(FATAL_ERROR
        "\nFailed to rebase in: 'D:/repos/AnimationAssign2/cmake/../external/libigl-imgui'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      _ep_accumulate_captured_output()
      _ep_message_quiet_capture(FATAL_ERROR
        "Failed to unstash changes in: 'D:/repos/AnimationAssign2/cmake/../external/libigl-imgui'.\n"
        "You will have to resolve the conflicts manually"
      )
    endif()
  endif()
