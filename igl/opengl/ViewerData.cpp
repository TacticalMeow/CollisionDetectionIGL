    ...
    const Eigen::MatrixXd& _V, const Eigen::MatrixXi& _F)
{
  ...
  if (V.rows() == 0 && F.rows() == 0)
  {
	...
	image_texture("E:/Repositories/Animation_igl_engine_build_assignment2/bin/textures/snake.jpg");
//    grid_texture();
  }
  else
  {
...
IGL_INLINE void igl::opengl::ViewerData::buildBox()
{
    //builds the surrounding box
